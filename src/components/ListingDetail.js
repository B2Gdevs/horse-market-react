				...
				<div className="container my-4">
					...
					<div className="row">
						<div className="col-md-12">
							...
							<p>
								...
								galley of type and scrambled it to make a type specim dummy text ever since the 1500s,
								when an unknown printer took a galley of type and scrambled it to make a type specimen
								book.been the industry's standard dummy text ever since the 1500s, when an unknown
								printer took a galley of type and scrambled it to make a type spec
							</p>
						</div>
					</div>
					...
					<div className="row">
						<button className={'btn btn-success mx-auto'} onClick={showModal}>
							<span>
								<AiOutlineMail className={'mx-2 contact-seller-icon'} />
							</span>Contact Seller
						</button>
